...
const ExporeSideFilters: React.FC<Props> = (props) => {
  return (
    <div className={"pt-40 w-[20rem] " + props.className}>
      <div className="grid gap-3 ">
        <button className="mr-16 underline text-gray-500 ">
          Clear Filters
        </button>
        <select
          className=" ml-12
            w-44 block pl-2  md:py-2 border border-black rounded-md text-sm md:text-base shadow-sm bg-gray-300
        ...
        <div className="ml-12 text-sm font-bold flex flex-col">
          ...
          <div className="flex flex-row gap-2">
            <input
              className="mt-2 w-20 text-sm font-thin bg-gray-200 placeholder:font-italitc border border-black rounded py-2 pl-2 pr-4 focus:outline-none "
              placeholder="Min"
              type="text"
            />
             <input
