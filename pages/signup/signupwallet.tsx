  ...
  return (
    <div className="font-space-grotesk grid h-screen place-items-center">
      <div className="-mt-96 grid place-items-center border px-10 py-5 md:px-40 md:py-20">
        ...
        <button className="w-60 border border-gray-400 hover:bg-gray-200 py-2.5">Wallet 1</button>
        <div className="my-1 md:my-2"></div>
        <button className="w-60 border border-gray-400 hover:bg-gray-200 py-2.5">Wallet 2</button>
        <div className="my-1 md:my-2"></div>
        <button className="w-60 border border-gray-400 hover:bg-gray-200 py-2.5">Wallet 3</button>
      </div>
